...
## Available MCP Tools (via cairn MCP server)

Full descriptions: `references/tools.md`. Names by layer:

- **Graph (L1):** explore, semantic_search, federated_search, find_definition, get_callers, get_callees, impact_analysis, search_symbols, repo_map, file_api, cross_repo_deps, visualize_graph
...
Cairn queues compass/wiki/flow synthesis as OKF tasks rather than calling
