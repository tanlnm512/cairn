...
@click.option("--codegraph-dir", default=str(DEFAULT_DB_PATH.parent))
def hooks_install(workspace, codegraph_dir):
    ...
    installed = install_hooks(repos, workspace, codegraph_dir)
