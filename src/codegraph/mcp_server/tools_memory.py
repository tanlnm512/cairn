...
def memory_digest(limit: int = 10) -> str:
    ...
    """
    from codegraph.memory.promotion import tribal_digest
...
def record_memory(
    ...
    """
    from codegraph.memory.promotion import capture_memory
...
def memory_promote(memory_path: str) -> str:
    ...
    from codegraph.memory.promotion import promote_memory
...
def memory_demote(memory_path: str, tier: str = "raw") -> str:
    ...
    from codegraph.memory.store import demote_memory
...
def memory_delete(memory_path: str) -> str:
    ...
    from codegraph.memory.store import delete_memory as dm
    from codegraph.memory.store import get_memory
