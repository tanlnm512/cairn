...
**Before-audit**: passed @ 68bd28c (2026-09-17: check.py 0 fail; suite 3418 green at 68bd28c; clean tree; branch feat/taint-tracking; 0/10 pre-done; C-01..C-04 reviewed)
...
- [x] T001 Define the taint registry contract and default source/sink tables — new src/cairn/graph/taint.py (FR-001, FR-005)
  - done 2026-09-17 — pytest tests/test_taint_registry.py — 9 passed (categories, override semantics)
...
- [x] T002 [P] (after T001) Wire taint source/sink overrides into workspace config — src/cairn/graph/config.py (FR-001, FR-005)
  - done 2026-09-17 — 71 config tests green; taint.sources/sinks flow to build_registry (TC-002 half)
...
- [x] T003 [P] (after T001) Implement the propagation engine and path/seed queries — src/cairn/graph/taint.py (FR-002, FR-003)
  - done 2026-09-17 — 22-check engine harness + real-workspace E2E: exact/fuzzy/depth-cap/cycles green
...
- [x] T004 (after T003) Add the cairn taint query command — new src/cairn/cli/taint.py registered via the package's `@main.command()` convention (src/cairn/cli/__init__.py:8) (FR-002, FR-003)
  - done 2026-09-17 — pytest tests/test_taint_cli.py — 7 passed; TC-001/003/004/006 proofs PASS
...
- [x] T005 (after T003) Ship the shared taint-warning formatter — src/cairn/graph/taint.py (FR-004)
  - done 2026-09-17 — pytest tests/test_taint_formatter.py — 4 passed; TC-007/008 text proven via intersect_seeds E2E
...
- [x] T006 [P] Build the eight test.md fixture workspaces — new specs/taint-tracking/fixtures/ tree: sql-flow, ambiguous-hop, clean-workspace, custom-config, framework-only, cli-shell, category-matrix, change-intersect (FR-001, FR-002, FR-003, FR-005)
  - done 2026-09-17 — 8 fixtures, 33 equivalence checks pass against landed engine
...
- [x] T007 (after T004) Add the Phase 1 fixture suite — new tests/test_taint_fixtures.py asserting the auto pass conditions of TC-001–TC-006 and TC-009–TC-011 (FR-001, FR-002, FR-003, FR-005)
  - done 2026-09-17 — pytest tests/test_taint_fixtures.py — 18 passed; 9 auto TCs + 10 category probes PASS
...
- [x] T008 [P] (after T007) Surface the taint warning in explore — src/cairn/mcp_server/tools_graph.py explore (:432, S4) (FR-004)
  - done 2026-09-17 — footnote/24-tool pins green; TC-008 on-path/off-path rendered (test_taint_surfaces.py)
...
- [x] T009 [P] (after T007) Add taint_paths to blast — src/cairn/graph/blast.py compute_blast (:471, S4) plus renderers (FR-004)
  - done 2026-09-17 — graft-parity blast pins green; 4 formats + --output render (test_taint_surfaces.py)
...
- [x] T010 (after T008) Add the Phase 2 surface assertions — new tests/test_taint_surfaces.py covering TC-007 and TC-008 (FR-004)
  - done 2026-09-17 — pytest tests/test_taint_surfaces.py — 6 passed (blast+explore surfaces, footnote-last, tool count)
