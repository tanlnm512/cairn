...
- Task entry (verbatim):
   - [ ] T004 (in-progress) (after T003) Add the cairn taint query command — new src/cairn/cli/taint.py registered via the package's `@main.command()` convention (src/cairn/cli/__init__.py:8) (FR-002, FR-003)
- spec_dir: specs/taint-tracking
