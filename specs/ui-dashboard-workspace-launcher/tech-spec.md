...
<!-- Blast radius: what existing code/symbols this touches, who calls them,
     what breaks if the approach is wrong. Use the workspace's graph tools
     when available (cairn: explore / impact_analysis / get_callers), else
     grep. Ground every claim in survey evidence. -->
