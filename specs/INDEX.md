...
- [ui-dashboard-traffic-scale](ui-dashboard-traffic-scale/spec.md) — draft (pagination, 24h/7d/30d/all time windows, bounded chains, <2s at 10k+ calls; pipeline docs filled 2026-08-20, implementation not started)
