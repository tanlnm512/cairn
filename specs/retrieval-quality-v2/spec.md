...
**Status**: done (closed 2026-08-17 on the document branch — no ship; all 24 tasks complete; verdict in `benchmarks/quality/ablation.{json,md}` — the unified record; originally `ablation-v2.{json,md}`, merged by PR #39)
**Created**: 2026-08-17
