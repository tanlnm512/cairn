...
smoke (``verify_tool_count``) pins the 24-tool contract (acceptance criterion).
...
# ---------------------------------------------------------------------------
# Tool-count gate (count pinned at 24)
# ---------------------------------------------------------------------------


def test_tool_count_at_24():
    """The 24-tool contract (server.py) holds.
