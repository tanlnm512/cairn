...
smoke (``verify_tool_count``) pins the 25-tool contract (acceptance criterion).
...
# ---------------------------------------------------------------------------
# Tool-count gate (count pinned at 25)
# ---------------------------------------------------------------------------


def test_tool_count_at_25():
    """The 25-tool contract (server.py) holds.
